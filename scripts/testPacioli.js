...
const reports = [
    "https://xbrlsite.azurewebsites.nhttps://xbrlsite.azurewebsites.net/2021/reporting-scheme/proof/reference-implementation/instance.xmlet/2021/reporting-scheme/proof/reference-implementation/instance.xml",
...
async function deploy() {
    ...
    try {
        ...
        await validation.methods.initValNoCohort(testHash, result[1], 0, "10000000000000000000").send({ from: dataSubscriber1, gas: 950000 });
        run++;
