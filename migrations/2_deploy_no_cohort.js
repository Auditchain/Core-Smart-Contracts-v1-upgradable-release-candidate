...
//   console.log("node operations address:", nodeOperations.address);
  ...
  await deployProxy(ValidationHelpers, ["0x0ce5B32A61B3429b1F66431D31898Bb8Bc474bb0", queue.address], { deployer, initializer: 'initialize' });
  let validationHelpers = await ValidationHelpers.deployed();
  console.log("validation helpers address:", validationHelpers.address);

  await deployProxy(NoCohort, ["0xC042aa39D1afc3334D758EAb89D464c456490d36", 
                               "0x0ce5B32A61B3429b1F66431D31898Bb8Bc474bb0", 
                               "0xeAf01977c7D24056D7C97cA3672EBbe9bEFd9183",
                               validationHelpers.address, 
                               queue.address], { deployer, initializer: 'initialize' });
